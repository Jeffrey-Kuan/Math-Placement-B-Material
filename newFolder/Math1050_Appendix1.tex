...
\title{Math 1050 Appendix 1}

\begin{document}


\section{Math 1050 Appendix 1}


\subsection*{Adding fractions using Least Common Denominators (LCD)}
\subsubsection*{I) Common denominators}
...
\subsubsection*{II) Least common denominator (LCD)}
...
$$\begin{aligned}
& 9=\underbrace{3}_{\text{common}} \times 3 \\
& 12=\overbrace{3}^{\text{common}} \times 2 \times 2
\end{aligned}$$
...
$$\begin{aligned}
& 36=\underbrace{2 \times 2}_{\text{common}} \times 3 \times 3 \\
& 8=\overbrace{2 \times 2}^{\text{common}} \times 2
\end{aligned}$$
...
$\checkmark$ Since all three numbers are even, they all divide evenly by 2 . Select 2, and perform the divisions:

$$16 \div 2=8 \quad 20 \div 2=10 \quad 50 \div 2=25$$

$\checkmark$ Replace the original three denominators by the results of the division: 8,10 and 25\\
$\checkmark$ Since the first two are still even, both divide evenly again by 2 . Select 2, and perform the divisions that are possible (we will not divide 25 by $2!$ )

$$8 \div 2=4 \quad 10 \div 2=5 \quad 25 \text { unchanged }$$

$\checkmark$ Replace the three numbers with the results of the divisions: 4,5 and 25\\
$\checkmark$ 4 is still even. Select 2 and perform the possible divisions (now both 5 and 25 will pass unchanged)

$$4 \div 2=2 \quad 5 \text { unchanged } \quad 25 \text { unchanged }$$

$\checkmark$ Replace again the numbers: $2,5,25$\\
$\checkmark$ 2 is even. Select 2 and perform the (final) division by 2

$$2 \div 2=1 \quad 5 \text { unchanged } \quad 25 \text { unchanged }$$

$\checkmark$ Replace the numbers by: 1, 5, 25\\
$\checkmark$ None of the numbers is even, we cannot divide by 2 anymore, since all numbers are odd. Skip 2\\
$\checkmark$ Check division by 3 - none divide evenly by 3. Skip 3\\
$\checkmark$ Check division by 5: both 5 and 25 work. Select 5 and perform the divisions that are possible:

$$1 \text { unchanged } \quad 5 \div 5=1 \quad 25 \div 5=5$$

$\checkmark$ Replace the numbers by: 1, 1 and 5\\
$\checkmark$ We can divide once more by 5 . Select 5 and divide:
...
$\checkmark$ The denominators are 35, 63, 45. We cannot divide either number by 2 ; skip 2. However, we can divide at least one by 3 ; select 3 :

$$35 \text { unchanged } \quad 63 \div 3=21 \quad 45 \div 3=15$$

$\checkmark$ The numbers are now 35, 21, 15. Divide again by 3; select 3:

$$35 \text { unchanged } \quad 21 \div 3=7 \quad 15 \div 3=5$$

$\checkmark$ The numbers are now 35, 7, 5. We cannot divide again by 3; skip now 3; we can divide by 5; select 5:

$$35 \div 5=7 \quad 7 \text { unchanged } \quad 5 \div 5=1$$

$\checkmark$ The numbers are now 7, 7, 1. None can be divided by 5 again; skip now 5. We can divide by 7; select7:
...
\begin{enumerate}
  ...
  \item $\frac{1}{8}+\frac{1}{6}$
  \item $\frac{7}{24}+\frac{11}{18}$
  \item $\frac{7}{60}-\frac{6}{75}$
  \item $4 \frac{2}{5}+\frac{7}{15}$
  \item $\frac{1}{12}+\frac{2}{15}-\frac{3}{20}$
\end{enumerate}
